...
<div class="barre1 row">
    ...
    <p class="compte col-auto"><a href="dashboard.php">dashboard</a><a href="compte.php" class="btn"><img class="logo_compte" src="img/compte.png" alt=""> compte</a></p>
</div>
...
<div class="barre2 row">
    <div class="div_logo col-auto mr-auto">
        <a href="index.php" class="btn nbt"><img class="logo_img" src="img/tarafé1.png" alt=""></a>
    </div>
...
<div class="barre3 row">
    <div class="barre_bouton">
        <ul class="ul_bouton row">
            ...
            <span class="0separator00"></span>
            <li class="li_bouton d_h"><a href="connexion.php" class="btn nbt">Connexion</a></li>
            <span class="0separator00"></span>
            <li class="li_bouton d_h"><a href="inscription.php" class="btn nbt">Inscription</a></li>
        </ul>
    </div>
